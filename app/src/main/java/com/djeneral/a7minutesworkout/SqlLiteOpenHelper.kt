...
class SqlLiteOpenHelper(context: Context, factory: SQLiteDatabase.CursorFactory?) : SQLiteOpenHelper(context, DATABASE_NAME, factory, DATABASE_VERSION) {
    ...
    companion object{
        ...
        private val COLUMN_COMPLETED_DATE = "completed_data"
    }
